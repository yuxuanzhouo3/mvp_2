...
function getFallbackPool(locale: "zh" | "en"): Record<RecommendationCategory, FallbackRecommendationItem[]> {
  if (locale === "en") {
    return {
      entertainment: [
        {
          ...
          reason: "Long-tail sci‑fi exploration based on common positive signals",
        ...
        {
          title: "Netflix Limited Series: Mystery Thrillers",
          description: "Short bingeable mystery-thriller limited series with solid ratings",
          reason: "A concrete sub-genre expansion that stays searchable",
          tags: ["tv", "mystery", "thriller", "limited series"],
          searchQuery: "Netflix limited series mystery thriller high rated",
          platform: "Netflix",
        ...
        },
        {
          ...
          reason: "Adjacent exploration from games into a specific niche",
        ...
        },
        {
          ...
          reason: "Music expansion to a practical use-case (focus)",
        ...
        {
          title: "Rotten Tomatoes: Best Animated Movies (Non‑Disney)",
          description: "Top-rated animation picks beyond mainstream studio titles",
          reason: "Long-tail curation and discovery within animation",
          tags: ["movies", "animation", "reviews", "top rated"],
          searchQuery: "best animated movies not disney rotten tomatoes list",
        ...
        },
        {
          ...
          reason: "Specific entertainment form with strong discoverability",
        ...
        },
        {
          ...
          reason: "Expands into social play without being generic",
        ...
        },
        {
          ...
          reason: "Music personalization by activity context",
      ...
      shopping: [
        {
          ...
          reason: "A concrete product niche with clear evaluation criteria",
        ...
        },
        {
          ...
          reason: "Expands into ergonomics and home office",
        ...
        },
        {
          ...
          reason: "A long-tail list with practical constraints",
        ...
        },
        {
          ...
          reason: "Home goods expansion grounded in utility",
      ...
      food: [
        {
          ...
          reason: "Expands from food into a concrete constraint (time + macros)",
        ...
        },
        {
          ...
          reason: "A specific cuisine + dining format for exploration",
          tags: ["food", "sushi", "restaurant", "omakase"],
          searchQuery: "omakase sushi near me best reviews",
          platform: "Google Maps",
        },
        {
          title: "Date‑Night Restaurants Nearby (Quiet 분위기)",
          description: "Look for low noise, good lighting, and reservation availability",
          reason: "Occasion-based dining expansion",
          tags: ["food", "date night", "restaurant", "reservation"],
          searchQuery: "date night restaurants near me quiet ambience",
          platform: "OpenTable",
        },
        {
          title: "Spicy Noodle Recipes (Heat Level Guide)",
          description: "Choose by spice level and pantry difficulty, with substitutions",
          reason: "Recipe exploration with a clear angle",
      ...
      travel: [
        {
          ...
          reason: "Concrete destination expansion with actionable structure",
        ...
        },
        {
          ...
          reason: "Long-tail itinerary format for quick planning",
        ...
        },
        {
          ...
          reason: "Adjacent exploration based on proximity constraint",
        ...
        },
        {
          ...
          reason: "Practical travel planning expansion",
      ...
      fitness: [
        {
          ...
          reason: "A real nearby place recommendation to improve consistency",
        ...
        },
        {
          ...
          reason: "A tutorial you can start immediately",
        ...
        },
        {
          ...
          description: "Key form cues and common mistakes to avoid shoulder/elbow pain",
          reason: "Equipment how-to focused on practical safety",
          tags: ["fitness", "dumbbell", "how to", "form"],
          searchQuery: "how to use dumbbells form tips beginner",
          platform: "YouTube Fitness",
        ...
        },
        {
          ...
          reason: "Expands into recovery and mobility",
